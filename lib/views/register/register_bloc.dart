...
class RegisterBloc {
  ...
  final _errorController = BehaviorSubject<Optional<String>>.seeded(Optional.absent());
  ...
  submit() async {
    print("submited");
    userApiService.register(_emailController.value, _pseudonymController.value, _passwordController.value)
    .then((id) async {
